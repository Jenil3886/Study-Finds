	...
	return (
		<>
			<form className="max-w-4xl mx-auto mt-24">
				<div className="flex flex-col gap-2">
					...
					<div className="mb-5 flex justify-center">
						<div className="w-[100px] h-[100px] relative select-none rounded-full flex justify-center items-center overflow-hidden">
							<input id="profile-image-upload" accept=".jpg,.jpeg,.png,.gif,.svg,.webp,.bmp,.ico,.avif" class="hidden" type="file" />
							<label
				...
				<div className="mb-5">
					<label for="name" className="block mb-2 text-[14px] font-bold  text-gray-900">
						Display Name
					</label>
					<input
						type="text"
				...
				<div className="mb-5">
					<label for="Bio" className="block mb-2 text-[14px] font-bold  text-gray-900">
						Bio
					</label>
					<input
						type="email"
				...
				<div className="mb-5">
					<label for="url" className="block mb-2 text-[14px] font-bold  text-gray-900">
						Website
					</label>
					<input
						type="url"
				...
				<div className="mb-5">
					<label for="location" className="block mb-2 text-[14px] font-bold  text-gray-900">
						Location
					</label>
					<input
						type="location"
