...
import { RelatedItemCard } from "../components/Item/RelatedItemCard";
    ...
    <div>
      ...
      >
        <div className="flex items-center gap-5 text-black">
          <button
            ...
            className="w-7 h-7 flex justify-center items-center text-lg rounded-full hover:bg-gray-100"
          >
            <IoIosArrowBack />
          </button>
      ...
      <div className="h-full flex m-4 gap-4 overflow-y-auto ">
        <div className="w-full lg:w-[70%] xl:w-[68%] 2xl:w-[65%]">
          {/* Article Title */}
          <h1 className="inline text-2xl md:text-3xl font-bold break-words hover:cursor-pointer">
            {item.title}
          </h1>
          ...
          <div className="flex justify-between items-start mt-2.5 mb-4">
            <div className="flex max-lg:flex-col gap-2">
              ...
              <div className="flex items-center gap-x-2">
                ...
                <span className="text-[13px] w-[100px] lg:max-2xl:w-[90px] pl-1 overflow-hidden whitespace-nowrap">
                  3 years ago
                </span>
              </div>
          ...
          <section className="mt-4 border-b flex flex-col gap-y-2">
            ...
            <div>
              New research from New York University reveals that living near busy roads increases
              the risk of premature death by 20%, primarily due to cardiovascular disease...
            </div>
          </section>
